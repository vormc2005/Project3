                ...
                <form >
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-12">
                      ...
                      <input name="startingbid" type="startingbid" class="form-control post-form" onChange ={handleInputChange} />
                    </div>
                    <div class="form-group col-md-12">

                      <label htmlFor="buyout">Buy out price</label>
                      <input id="buyout" name="buyout" type="buyout" class="form-control post-form" onChange ={handleInputChange} />
                    </div>
